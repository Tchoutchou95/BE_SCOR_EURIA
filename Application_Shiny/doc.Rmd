...
The input dataset is supposed to have at least 2 columns(X & Y}) ans separator is (;), the first one is to be the abscissa, i.e. the bins under which values are count, and the second one is to be the counts. And eventually a last column for offset datas (Offset)
